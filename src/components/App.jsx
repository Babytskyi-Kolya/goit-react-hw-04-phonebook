...
export const App = () => {
  ...
  const addContactUser = nevUser => {
    ...
    setContacts(prevState => [nevUser, ...prevState]);
  };
  ...
  return (
    <Div>
      <H2>Phone Book</H2>
      <FormContact onAdd={addContactUser} />
      ...
      {contacts.length === 0 ? (
        ...
        <ListContacts contacts={visibleContactItems} onDelete={handleDelete} />
      )}
    </Div>
  );
};
